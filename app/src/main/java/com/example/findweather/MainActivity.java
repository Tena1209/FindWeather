...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GetDataFromInternet.AsyncResponse  {
    ...
    public void onClick(View v) {
        ...
        //URL url = new URL("https://api.openweathermap.org/data/2.5/weather?q=Stroitel'&appid=9b27a550d2993692ec995f3ca08c2b22");
    ...
    private  URL buildUrl (String city) {
        ...
        String appid_value= "9b27a550d2993692ec995f3ca08c2b22";
